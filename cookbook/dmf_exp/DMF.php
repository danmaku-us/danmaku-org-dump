...
$HTMLHeaderFmt['javascripts'] = "\n".'<script type="text/javascript" src="/static/min/?b=dmf/static&amp;f=jquery-1.6.1.min.js,qule.js,swfobject.js,jquery-ui-1.8.14.custom.min.js,pdm-bili.js"></script>'."\n";
...
include_once(DMF_ROOT_PATH."ReadInfo.php");
